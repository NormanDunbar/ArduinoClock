#include <TinyWireM.h>              // for I2C communication
 ...
 *  
 *  This entire file is a conversion of the original code, above, for the ATtiny85
 *  microcontroller. Just to see if it could be done!
 */
